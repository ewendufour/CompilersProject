...
(*| MATCH me=multiple_expr WITH nc=nested_cases {NMatch(me,nc)} *)
...
| e=expression COMMA el=multiple_expr { e :: el }

nested_cases:
| BAR pl=separated_nonempty_list(COMMA, pattern) ARROW e=expression { (pl, e) :: [] }
| BAR pl=separated_nonempty_list(COMMA, pattern) ARROW e=expression ncases=nested_cases { (pl, e) :: ncases }
*)
cases:
